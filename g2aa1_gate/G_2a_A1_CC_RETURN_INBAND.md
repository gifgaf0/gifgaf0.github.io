# G-2a-A1 — CC LEG RETURN (P-4 single-file, mirrored)

**Gate:** G-2a-A1 (Gate 2a: Baryon Spin Geometry & Factor Assignment). **Leg:** CC. **Date:** September 21, 2026.
**Dispatch consumed:** `G_2a_A1_CC_DISPATCH_INBAND.md` under the verbatim activation flag `ACTIVATE: G-2a-A1-CC-LEG-1`.
**Lock chain honoured (md5-guarded at every invocation):** memo v2 `626aa868844220eb6c3801ef07a77783` (61,562 B) · lock record `8732c390be1f442faa589bf04f7ffe9f` · schema v1.0 `53111e0360dac138b02d5914efe85d5c` · comparator v1.0 `5afcd5890a9248f01a3d8a203e349039` (15/15 selftest suites re-run green here before the build) · gate T1 list `2026b782db3905d9f2ce35733823618c` (24 patterns; scanner `6b86290090a8c84f1b1a0a99ec0bf697`) · extract `940b0bee4b2112e911ae738c3db2bc3d`.
**Blindness discipline:** the seven QUARANTINED embeds were decoded only after the pre-consultation checkpoint was committed; the extractor SKIP log, the commit order below and the git history of branch `claude/new-session-j6430a` are the witnesses.

## 1. Branch and commits (pre-consultation first)

Repository `gifgaf0/gifgaf0.github.io`, branch **`claude/new-session-j6430a`**, directory `g2aa1_gate/`.

| Commit | Content |
|---|---|
| `8323968` | **pre-consultation checkpoint** — instrument `g_2a_a1_ccleg.py` (md5 `006cb5213208e41cc57cfe045b7d3dd4`) + `g_2a_a1_ccleg_checkpoint.json` (md5 `bbf94221122136f00c5ecad0b90e5313`, quoted in the commit message) + dispatch, plain embeds, T1 tools. Armor unopened. |
| `2be2afc` | armor opened; the seven chat-leg artifacts decoded (all md5-verified); frozen comparator v1.0 run → `g_2a_a1_twoleg_comparison.json` (md5 `5942248e4be4b357017c6822817ca4c2`); chat-vs-chat sanity re-run (byte-identical to the quarantined `ba087607` file); CC-vs-CC sanity `g_2a_a1_ccleg_compare.json` (md5 `73a19a11288475ed3eb8935e0a3f9c66`). |
| (this commit) | this return file. |

## 2. Instrument and execution summary

`g_2a_a1_ccleg.py` built from the memo (§0–§2, §4–§7, §A), lock-record Addendum A-2 and the schema only, in CC's own structure; the quarantined chat instrument was never consulted. **Method variations executed as requested (dispatch §3):** g₂ built as the 14-dimensional annihilator of the associative 3-form φ inside so(7) (kernel of the 35×21 exact system; every basis element then verified to satisfy the derivation identity on all 64 basis products — the two constructions agree); SL(2,7) enumerated from scratch over 𝔽₇ (336 elements, 11 conjugacy classes by own orbit enumeration) and GL(3,2) enumerated from scratch for the reality of the 6 (2-transitivity on the 7 Fano points, Σ|fix|²/|G| = 2) with the 7 from the own P¹(𝔽₇) action (2-transitive on 8 points); the homotopy bookkeeping is an own exact-sequence module (zero-flanked LES segments only, every deduction an explicit assert); branchings of the four sl₂-classes read from exact Casimir spectra (Killing-normalized, rational 7×7 eigen-rank computations) for the long-root / short-root / su(3) classes and from an exact sl₂-triple ([h,e] = 2e, [h,f] = −2f, [e,f] = h over complex rationals, weights {0, ±2, ±4, ±6}) for the principal class. Exact arithmetic throughout (Fraction; ℚ(√2) for 2O; complex rationals for the triple); floats only in the spinorial-2O block (A-2.3) and the Phase-2 geometric integral. **Run time: 3.9 s.**

**Phase 0 (all controls PASS).** (0b) **The full continuous stabilizer of the oriented density inside so(16), computed as the exact kernel of the 1120×120 rational coefficient map: dimension 15 = g₂ (14) ⊕ u(1)_{ψ₀} (1)** — the extra generator is the phase rotation of the real-unit component alone (O carries only imaginary indices; the two-body term sees only |ψ|²); the 15 named generators are verified to lie in the kernel and to span it. The 7-sector continuous symmetry is exactly g₂; the diagonal phase is broken by O to ℤ₃ (`phase_subgroup_order` 3; `O_phase_invariant` false); conjugation carries O ↦ Ō (exact, φ real); a generic so(16) rotation breaks O at margin 1 (exact). Schema keys recorded as `sym_int_continuous = "G2"`, dim 14 (CC-DD-2 below); the full-stabilizer finding is in the checkpoint's `extras` and here. (0c) The term list of record couples internal indices only through δ and φ and spatial indices only through the scalar/∂x∧∂y structures → direct product holds, **F-A1-1 does not fire**. (0d) V = S¹⁵, π₁ = π₄ = 0; locking inventory by exact stabilizer nullspaces: rank 0 → G₂ (14), rank 1 → SU(3) (8), rank 2 → SU(2)_long (3, and the e₄-kill is automatic from the derivation property — verified); all π₃-injective (long-root index 1), π₄(G₂/H₀) = 0. (0e) L_⊥ψ₀ = 0 exact; F₂₁ = 21 unsigned collineation-automorphisms, 7 = 1 ⊕ 3 ⊕ 3̄ (trivial multiplicity 1, norm 3, conjugate residue-orbits {1,2,4}/{3,5,6}).

**Phase 1.** **T1 holds:** ⟨χ_{3/2}, χ_{3/2}⟩ = 1, χ(1) = 4, χ(−1) = −4, **FS indicator −1** (all exact in ℚ(√2)); the 7 real (commutant of the g₂ action = ℝ, dimension 1); even-multiplicity bound ⌊7/4⌋ → **quartet multiplicity 0**; 2O-abelianization ℤ₂ (derived subgroup of order 24 machine-closed) → phase character trivial; branchings **[2,2,1,1,1] / [3,2,2] / [3,3,1] / [7]** — no 4 anywhere; control Sym³ quartet multiplicity 1. **T2 holds:** dim = 14 (φ-stabilizer = derivations); Cℓ(0,7) relations verified; bivector spans 21 and 15; g₂ ⊂ spin(7)_L; **dim(g₂ ∩ su(4)_L) = 8**; su(4)_L is exactly the traceless anti-Hermitian algebra on (ℝ⁸, J = L₇) in the basis (e₀,e₁,e₂,e₄) (rank 15, exact) so the spin-3/2 su(2) lies inside it; the 48 spinorial elements: **zero-defect count 0 over 2O∖{±Id}** (CC-DD-1), minimum defect 0.7071 (> 10⁻⁶), quartet multiplicity **2** (= 4 ⊕ 4̄, control C-A1-2); SL(2,7): **exactly 2** solutions of g² = 1, ordinary FS sum 22, Diophantine → **nu4_allowed = [−1, 0]**; every order-2 element of the 1344 group has trace **−1**; σ_ℍ is an automorphism (trace −1), a single-unit negation is not; the 1344 group enumerated as the full set of signed-permutation automorphisms (order 1344, all pass the automorphism test). **T3 holds:** π₁(G₂) = 0, π₃(G₂) = ℤ, π₄(G₂) = 0 from SU(3) → G₂ → S⁶; π₁(V) = π₄(V) = 0; no internal double cover; envelope-in-𝕆 kill (π₂(S⁶) = 0); controls π₄(S²) = ℤ₂ (own LES from the Hopf fibration), π₄(S³) = ℤ₂, |π₁(SO(3)/T)| = 24 (2T machine-enumerated and closed). **T4 holds:** the three pointwise-line-stabilizer collineations of {1,2,4} (found by exhaustion: exactly 4 fixing the line pointwise, incl. identity) have **24 signed lifts: 12 of order 2 all with trace −1**; 12 of order 4 with traces {−1, 3}, every trace-3 lift squaring to a trace-−1 involution; permutation character 3, χ₆(2A) = 2, **gap 4**; ν₂ multiplier an unsigned automorphism. **The 1344 group (E-A1-6(a)):** presentation generators a = (3 5)(6 7), b = a machine-found order-3 collineation with ord(ab) = 7, ord([a,b]) = 4, ⟨a,b⟩ = 168; **64 lift pairs tested, 0 generate order 168 → NON-SPLIT** (banked R1 structural; H-A1-3 concordant).

**Phase 1b.** P-ℂ: complex unit central (exact commutation with every L_a on ℝ¹⁶); e₈ anticommutes with every imaginary unit (exact Cayley–Dickson) → not central → **CLOSED-BY-INSTANTIATION**. H screen: H1 EXCLUDED(i,iii) (role control), **H2 ADMISSIBLE-IMPORT**, **H3 ADMISSIBLE-IMPORT**, H4 EXCLUDED(i) (its ℍ_L^⊥ module is the 2 ⊕ 2 of the long-root branching, Casimir 3/4), H5 EXCLUDED — code-string divergence on H5 is CC-DD-3/definitional below. **Admissible = {H2, H3}, both imports → I5 registered.**

**Phase 2 (E-A1-2(a); zero verdict weight).** O = φ_abc × the common geometric integral (Simpson vs the exact 2π[cos f]₀^∞ = 4π, agreement 10⁻⁴): **|O_line| = 4π = 12.566…, O_nonline = 0 exactly** (φ₁₂₃ = 0). The locked family: exact affine solve for {X ∈ g₂ : Xe₄ = 0, Xe₁ = e₂, Xe₂ = −e₁} — a coset of SU(2)_long (kernel dimension 3, as required); internal image SO(4) = Stab_{G₂}(ℍ_L), kernel SU(2)_long, subdirect, π₀(Stab) = 1 (the ℤ₃ phase does not fix the real-amplitude texture). The two lifts, **exact**: X_σ (the su(2)_long-orthogonal representative; its ⊥-block A_R satisfies A_R² = −I/4 exactly, so exp(2πX_σ) = σ_ℍ by closed form) and X_d = X_σ + k̂ (k̂ ∈ su(2)_long with k̂²|⊥ = −I/4, commuting blocks, so exp(2πX_d) = Id) → **loop_images = {Id, σ_ℍ}**, σ_ℍ eigenvalues +1 ×4 / −1 ×4, label **INTERNAL-HOLONOMY-GAUGE**; **π₁(Orbit) = 0**; the chiral pair transforms by e^{±iα} (weights ±1 exact) — ordinary. The optional MV-G1 crystallized-core extension was **not** executed (CC-optional; see Deviations).

**Phase 3 (machine-assigned, last): verdict class ASSIGNMENT-I-FORCED** — T1, T2, T3, T4 all hold, direct product holds, Sym_int pinned, all controls pass. Identical, independently, to the chat verdict.

## 3. Two-leg comparison (frozen comparator v1.0)

**436 checks, 430 PASS, 6 MISS → S9.** Classification of every miss (dispatch §4), against the chat execution report §7 read only after the pre-consultation commit:

| # | Miss | chat | cc | Classification |
|---|---|---|---|---|
| 1 | `phase0.sym_int_continuous` equal | `G2xU1_psi0` | `G2` | **definitional** — both legs computed the identical stabilizer (dim 15 = g₂ ⊕ u(1)_{ψ₀}, same identification); the divergence is the recording convention against a schema frozen before the finding (chat H-A1-1; CC-DD-2). No mathematical disagreement. |
| 2 | `phase0.sym_int_continuous_dim` equal | 15 | 14 | **definitional** — same item; CC's 15 is in `extras.full_O_density_stabilizer_so16`. |
| 3 | `phase0.sym_int_continuous` (chat) in domain | out of domain | — | **definitional** — the pre-declared H-A1-1 domain row (the frozen domain lists only "G2"). |
| 4 | `phase1.T2.spinor_2O_automorphism_count` equal | 1 | 0 | **definitional** — count domain: chat counts zero-defect elements including the identity (A-2.3 wording), CC counts over 2O∖{±Id} (A-2.3 expectation "expected 0"; CC-DD-1). The defect data are identical (min 0.7071 both legs; +Id is the only zero-defect element on either leg). |
| 5 | `phase1b.H_screen.H5.i` equal | fail | pass | **definitional** — whether the e₈ anticommutation is booked under criterion (i) (chat: not tensor-commuting) or under the P-ℂ centrality token (CC, following the a-priori code strings). Same exclusion either way. |
| 6 | `phase1b.H_screen.H5.code` equal | EXCLUDED(i,ii) | EXCLUDED(ii,centrality) | **definitional** — consequence of #5 (the code-rule divergence, CC-DD-3). The admissible sets are identical: {H2, H3}. |

**Zero representational and zero substantive misses.** Every witness value, every float rule, every verdict recomputation and every consistency check agrees. Independence witness PASS (instrument md5s differ; 53,706 B chat vs 76,216 B CC, different structure and methods). Neither checkpoint was edited at any point.

**Chat-vs-chat sanity re-run:** the frozen comparator run here on the chat checkpoint against itself reproduces the quarantined `g_2a_a1_chatleg_compare.json` (`ba0876074396e697614a4daa78da7682`) **byte-identically** (436/432/4: the two structural self-comparison rows + the two H-A1-1 domain rows). **CC-vs-CC sanity:** 436/434/2 — the two structural self-comparison rows only (CC is in-domain on `sym_int_continuous`); embedded below.

## 4. CC-DD (definitions CC had to fix)

- **CC-DD-1 — `spinor_2O_automorphism_count` domain.** A-2.3 says "the count of elements with defect 0 (expected 0)", but +Id trivially has defect 0, so the expectation and the literal wording conflict. CC counts over 2O∖{±Id} (the domain A-2.3 itself uses for the minimum defect), giving 0. Chat counted literally, giving 1. Comparator miss #4; definitional.
- **CC-DD-2 — `sym_int_continuous` recording.** Having found the full O-density stabilizer to be 15-dimensional (g₂ ⊕ u(1)_{ψ₀}), CC records the frozen-schema keys as the memo-pinned `"G2"` / 14 — the continuous internal symmetry acting on the octonionic index, which is what every test consumes — and reports the full stabilizer in `extras` and here. Chat recorded the full stabilizer in the schema keys, deliberately out of domain. Comparator misses #1–3; definitional.
- **CC-DD-3 — H-screen code rule.** The rule CC used (stated verbatim, as the dispatch requires): *code = `ADMISSIBLE-IMPORT` when no criterion is `fail` (`conditional` / `dynamical` / `kinematic` allowed); otherwise `EXCLUDED(` + the comma-joined failed criterion labels, with `centrality` appended for the P-ℂ exclusion of H5 + `)`* — following the memo §2.4 candidate texts ("fails (ii) … and the centrality of P-ℂ"). Chat's rule books the H5 centrality failure as criterion (i) = fail instead. Comparator misses #5–6; definitional.

## 5. H-CC (self-caught items, disagreements with memo / lock record / schema)

- **H-CC-1 — the decoupled real-unit phase (independently found; corroborates chat H-A1-1).** The memo's Phase-0 sentence "continuous part exactly G₂" misses the u(1)_{ψ₀} on the real-unit complex line: the CC leg's own exact so(16) kernel computation gives dimension **15**, identification **g₂ ⊕ u(1)_{ψ₀}**, with the 7-sector continuous symmetry exactly g₂ and the diagonal phase ℤ₃ — the same finding, by a different construction, as the chat leg. No test is affected (the u(1) contributes only ordinary characters on the summand 1; it cannot supply the central −Id on the 7-sector; V and its homotopy are unchanged; an abelian u(1) yields no binary-polyhedral π₁). It does not fire F-A1-1 (no spinor SU(4), no spinorial SL(2,7)/2O). On the chat-side schema v1.1 candidate (domain widened to ["G2", "G2xU1_psi0"]): CC seconds that the widened domain resolves comparator misses #1–3 cleanly; the election is the author's (S9); schema and comparator were left untouched here, as required.
- **H-CC-2 — lock record A-2.2 index expectation.** A-2.2's parenthetical expects the su(3)-sl₂ class index to be 1. CC computes the embedding indices (normalized to long-root = 1, from the exact branchings): long-root **1**, short-root **3**, su(3)-sl₂ **4**, principal **28**. The [3,3,1] class is the principal sl₂ *of su(3)* (the 3 irreducible), whose index is 4, not 1; index 1 would be the regular su(2) ⊂ su(3), whose branching is [2,2,1,1,1], not [3,3,1]. The lock record's "1" appears to be a slip. Witness-only (A-2.2: "the index values are witnesses, not verdict-bearing"); no schema key carries these indices; no comparator impact. For the author's record.
- **H-CC-3 — self-caught build bug (before any committed result).** The first draft of the g₂-condition assembler indexed the antisymmetric unknown x_{dd} for the diagonal term d = a and crashed on the first run; fixed by skipping the vanishing diagonal. No result existed before the fix; the instrument md5 above is the final one.

## 6. Deviations

- None from the binding order of operations: memo/lock-record/schema read → instrument from scratch → Phase 0 → 1 → 1b → 2 → 3 → checkpoint → **commit** → armor opened → comparison → this return. The verdict was the last computation; the checkpoint was never edited after the comparison.
- The CC-optional MV-G1 crystallized-core Phase-2 extension was not executed (the schema's Phase-2 keys refer to the homogeneous pinned witness, which was).
- The CC-vs-CC comparator sanity was run after armor opening (it is a witness convenience, not a dispatched pre-consultation step); the pre-consultation estate is exactly what dispatch §3 ordered: instrument + checkpoint, committed.

## 7. T1 state

Gate list `2026b782db3905d9f2ce35733823618c` (24 patterns) md5-asserted (never self-scanned); scanner `6b86290090a8c84f1b1a0a99ec0bf697` md5-asserted. At every instrument invocation: instrument, memo and extract scan **CLEAN** (0 hits, 0 numeric collisions); halt-on-hit with no override flag. Post-run scans, all **CLEAN**: the checkpoint, the two-leg comparison, the CC-vs-CC comparison, the decoded chat artifacts, and this return file (scanned before commit). D-A1-1 (the armor-transport collision inside one dispatch base64 body) is acknowledged; nothing here changes it.

## 8. The Phase-0 stabilizer, the H-screen code rule, run time (dispatch §5 checklist)

- **Phase-0 stabilizer of the oriented density in so(16):** dimension **15**, identification **g₂ ⊕ u(1)_{ψ₀}** (g₂ acting ℂ-linearly on the octonionic index; the u(1) a phase on the real-unit complex line alone, decoupled because O carries only imaginary indices and the two-body kernel sees only the density). 7-sector: exactly g₂ (dim 14). Diagonal phase: ℤ₃. Conjugation: O ↦ Ō.
- **H-screen code rule:** as stated verbatim in CC-DD-3.
- **Run time:** 3.9 s (single invocation, all phases; guards and T1 self-scan included).

## 9. Embeds

Five byte-exact embeds follow (sentinel format of the dispatch): the CC instrument, the CC checkpoint, the two-leg comparison, the chat-side comparison as re-run here (byte-identical to the quarantined original), and the CC-vs-CC sanity.

=====BEGIN-EMBED name=g_2a_a1_ccleg.py md5=006cb5213208e41cc57cfe045b7d3dd4 bytes=76216 encoding=raw=====
#!/usr/bin/env python3
...
if __name__ == "__main__":
    main()
=====END-EMBED name=g_2a_a1_ccleg.py=====

=====BEGIN-EMBED name=g_2a_a1_ccleg_checkpoint.json md5=bbf94221122136f00c5ecad0b90e5313 bytes=8652 encoding=raw=====
{
 ...
 "extras": {
  "H_screen_code_rule": "code = 'ADMISSIBLE-IMPORT' when no criterion is 'fail' (conditional/dynamical/kinematic allowed); otherwise 'EXCLUDED(' + comma-joined failed criterion labels, with 'centrality' appended for the P-C exclusion of H5 + ')'",
  "elapsed_seconds": 3.88,
  "full_O_density_stabilizer_so16": {
   "dim": 15,
   "identification": "g2 (acting C-linearly on the octonionic index) + u(1) acting on the real-unit complex line alone; the u(1) is an accidental spectator (Q-A1-3: no real-unit-splitting term) and acts trivially on Im(O) tensor C"
  },
  "generic_so16_margin": "1",
  "group1344_generators": {
   "a": "collineation (3 5)(6 7), fixes {1,2,4} pointwise",
   "b": "order-3 collineation [(1, 2), (2, 3), (3, 1), (4, 5), (5, 7), (6, 6), (7, 4)] with ord(ab)=7, ord([a,b])=4, <a,b> = 168"
  },
  "phase2_lift_matrices": {
   "X_sigma_lift_su2long_free_note": "X_s: holonomy exp(2 pi X_s) = sigma_H exactly (A_R^2 = -I/4 on the perp block); X_d = X_s + khat: holonomy Id (commuting -I x -I); both verified by exact closed forms, matrices in the return file",
   "sigma_H_diag_on_e1..e7": [
    1,
    1,
    -1,
    1,
  ...
  "sl2_class_indices_normalized_long_root_1": {
   "long_root": "1",
   "principal": "28",
   "short_root": "3",
   "su3_sl2": "4"
  },
  "spinor_2O_automorphism_count_domain": "count over 2O minus {+-Id} (CC-DD-1): +Id is trivially an automorphism; A-2.3's min-defect domain already excludes +-Id"
 },
 "gate": "G-2a-A1",
 "instrument_md5": "006cb5213208e41cc57cfe045b7d3dd4",
 "ledger_base_md5": "40009ec0197876b130766f1ae7494360",
 "leg": "cc",
 ...
 "phase0": {
  "O_phase_invariant": false,
  "complex_amplitudes": 8,
  "conjugation_maps_O_to_conjugate": true,
  "controls": {
   "F21_split_1_3_3bar": true,
   "L_perp_zero_mode": true,
   "generic_so16_fails_margin_positive": true
  },
  "field_real_components": 16,
  "g2_preserves_O": true,
  "generic_so16_breaks_O": true,
  "locking_inventory": [
   {
    ...
    "pi4_quotient": 0,
    "rank": 0,
    "sl2_generator_index": 1,
    "sl2_generator_jordan_type": [
     2,
     2,
     1,
     1,
  ...
  "phase_subgroup_order": 3,
  "pi1_V": 0,
  "pi4_V": 0,
  "real_unit_splitting_term_present": false,
  "spatial_internal_direct_product": true,
  "spinor_index_present": false,
  "sym_int_continuous": "G2",
  "sym_int_continuous_dim": 14,
  "sym_int_pinned": true,
 ...
 "phase1": {
  "T1": {
   ...
   "chi32_at_minus1": -4,
   "chi32_norm": 1,
   "control_sym3_quartet_mult": 1,
   "fs_indicator": -1,
   "holds": true,
   "phase_char_on_2O_trivial": true,
   "quartet_multiplicity_upper": 0,
   "seven_real": true
  },
  "T2": {
   "control_1344_all_automorphisms": true,
   "dim_bivectors_6": 15,
   "dim_bivectors_7": 21,
   "dim_der": 14,
   "dim_g2_cap_su4": 8,
   ...
   "sigma_H_is_automorphism": true,
   "single_unit_negation_is_automorphism": false,
   "sl27_order": 336,
   "sl27_sq1_count": 2,
   "spinor_2O_automorphism_count": 0,
   "spinor_2O_min_automorphism_defect": 0.7071067811865474,
   "spinor_2O_order": 48,
   "spinor_2O_quartet_mult": 2
  },
  "T3": {
   "controls_pi1_SO3_mod_T": 24,
   "controls_pi4_S2": "Z2",
   "controls_pi4_S3": "Z2",
   "envelope_in_O_kill": true,
   "holds": true,
   "no_internal_double_cover": true,
   "pi1_G2": 0,
   "pi1_V": 0,
   "pi3_G2": "Z",
   "pi4_G2": 0,
  ...
  "T4": {
   "control_F21_unsigned_1_3_3bar": true,
   "gap": 4,
   "holds": true,
   "lifts_total": 24,
   "nu2_unsigned_automorphism": true,
   "order2_count": 12,
   "order2_traces_set": [
    -1
   ],
   ...
   "perm_char_involution": 3,
   "rho6_char_2A": 2
  },
  "group1344": {
   "complements_found": 0,
   "lift_pairs_tested": 64,
   "order": 1344,
   "split": false
  }
 },
 "phase1b": {
  ...
  "I5_registered": true,
  "P_C": {
   "complex_unit_central": true,
   "disposition": "CLOSED-BY-INSTANTIATION",
   "e8_anticommutes": true,
   "e8_central": false
  },
  "admissible": [
   "H2",
 ...
 "phase2": {
  "O_line_abs": 12.566369857446146,
  "O_nonline_abs": 0.0,
  "O_nonzero_on_line": true,
  "O_zero_on_nonline": true,
  "chiral_pair_character_ordinary": true,
  "control_object": "nonline_texture_L123",
  "dimension_note": "2D witness; contractibility of the 2pi loop in the orbit only",
  "label": "INTERNAL-HOLONOMY-GAUGE",
  "loop_images": [
  ...
  "pi1_orbit": 0,
  "profile_id": "lockrec-A-2.6",
  "sigma_H_eigen_minus1": 4,
  "sigma_H_eigen_plus1": 4,
  "stab_internal_image": "SO4_Stab_HL",
  "stab_kernel": "SU2_long",
  "stab_subdirect": true
 },
...
=====END-EMBED name=g_2a_a1_ccleg_checkpoint.json=====

=====BEGIN-EMBED name=g_2a_a1_twoleg_comparison.json md5=5942248e4be4b357017c6822817ca4c2 bytes=66776 encoding=raw=====
{
 "cc_ckpt_md5": "bbf94221122136f00c5ecad0b90e5313",
 "chat_ckpt_md5": "8f657a23a68ef082f99a7579af78348c",
 "comparator": "g_2a_a1_compare_v1_0",
 "misses": [
  {
   "cc": "G2",
   "chat": "G2xU1_psi0",
   "check": "C1",
   "name": "phase0.sym_int_continuous equal",
   "note": "",
   "pass": false
  },
  {
   ...
   "chat": 15,
   "check": "C1",
   "name": "phase0.sym_int_continuous_dim equal",
   "note": "",
   "pass": false
  },
  {
   ...
   "chat": "G2xU1_psi0",
   "check": "C1",
   "name": "phase0.sym_int_continuous (chat) in domain",
   "note": "",
   "pass": false
  },
  {
   ...
   "chat": 1,
   "check": "C2",
   "name": "phase1.T2.spinor_2O_automorphism_count equal",
   "note": "",
   "pass": false
  },
  {
   ...
   "chat": "fail",
   "check": "C3",
   "name": "phase1b.H_screen.H5.i equal",
   "note": "",
   "pass": false
  },
  {
   "cc": "EXCLUDED(ii,centrality)",
   "chat": "EXCLUDED(i,ii)",
   "check": "C3",
   "name": "phase1b.H_screen.H5.code equal",
   "note": "",
   "pass": false
  }
 ],
 "rows": [
  ...
  },
  {
   ...
   "chat": null,
   "check": "C0",
   "name": "required key action_extract_md5 present (chat)",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C0",
   "name": "required key action_extract_md5 present (cc)",
   "note": "",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": null,
   "check": "C0",
   "name": "required key phase1 present (chat)",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C0",
   "name": "required key phase1 present (cc)",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C0",
   "name": "required key phase1b present (chat)",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C0",
   "name": "required key phase1b present (cc)",
   "note": "",
   "pass": true
  },
  {
  ...
  {
   "cc": "626aa868844220eb6c3801ef07a77783",
   "chat": "626aa868844220eb6c3801ef07a77783",
   "check": "C0",
  ...
  {
   "cc": "40009ec0197876b130766f1ae7494360",
   "chat": "40009ec0197876b130766f1ae7494360",
   "check": "C0",
  ...
  {
   "cc": "2026b782db3905d9f2ce35733823618c",
   "chat": "2026b782db3905d9f2ce35733823618c",
   "check": "C0",
  ...
  {
   "cc": "940b0bee4b2112e911ae738c3db2bc3d",
   "chat": "940b0bee4b2112e911ae738c3db2bc3d",
   "check": "C0",
   "name": "action_extract_md5 == schema (chat)",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "940b0bee4b2112e911ae738c3db2bc3d",
   "check": "C0",
   "name": "action_extract_md5 == schema (cc)",
   "note": "",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": "CLEAN",
   "check": "C0",
   "name": "t1_scan.extract CLEAN (chat)",
   "note": "",
   "pass": true
  },
  {
  ...
  {
   "cc": "006cb5213208e41cc57cfe045b7d3dd4",
   "chat": "6360709d6a7eb5fc3df7fc8fd26dc36a",
   "check": "C0",
  ...
  },
  {
   ...
   "chat": 16,
   "check": "C1",
   "name": "phase0.field_real_components typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 16,
   "check": "C1",
   "name": "phase0.field_real_components equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 8,
   "check": "C1",
   "name": "phase0.complex_amplitudes typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 8,
   "check": "C1",
   "name": "phase0.complex_amplitudes equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": false,
   "check": "C1",
   "name": "phase0.spinor_index_present typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": false,
   "check": "C1",
   "name": "phase0.spinor_index_present equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.spatial_internal_direct_product typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.spatial_internal_direct_product equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.sym_int_pinned typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.sym_int_pinned equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "G2xU1_psi0",
   "check": "C1",
   "name": "phase0.sym_int_continuous typed",
   "note": "type str",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": 15,
   "check": "C1",
   "name": "phase0.sym_int_continuous_dim typed",
   "note": "type int",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.g2_preserves_O typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.g2_preserves_O equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.generic_so16_breaks_O typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.generic_so16_breaks_O equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 3,
   "check": "C1",
   "name": "phase0.phase_subgroup_order typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 3,
   "check": "C1",
   "name": "phase0.phase_subgroup_order equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": false,
   "check": "C1",
   "name": "phase0.O_phase_invariant typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": false,
   "check": "C1",
   "name": "phase0.O_phase_invariant equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.conjugation_maps_O_to_conjugate typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.conjugation_maps_O_to_conjugate equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "O(16)",
   "check": "C1",
   "name": "phase0.two_body_symmetry typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "O(16)",
   "check": "C1",
   "name": "phase0.two_body_symmetry equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "S15",
   "check": "C1",
   "name": "phase0.vacuum_manifold_of_record typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "S15",
   "check": "C1",
   "name": "phase0.vacuum_manifold_of_record equal",
   "note": "",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": false,
   "check": "C1",
   "name": "phase0.real_unit_splitting_term_present typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": false,
   "check": "C1",
   "name": "phase0.real_unit_splitting_term_present equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.controls.L_perp_zero_mode typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.controls.L_perp_zero_mode equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.controls.F21_split_1_3_3bar typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.controls.F21_split_1_3_3bar equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.controls.generic_so16_fails_margin_positive typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.controls.generic_so16_fails_margin_positive equal",
   "note": "",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": null,
   "check": "C1",
   "name": "phase0.sym_int_continuous (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "O(16)",
   "check": "C1",
   "name": "phase0.two_body_symmetry (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C1",
   "name": "phase0.two_body_symmetry (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "S15",
   "check": "C1",
   "name": "phase0.vacuum_manifold_of_record (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C1",
   "name": "phase0.vacuum_manifold_of_record (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.controls.L_perp_zero_mode true both legs",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.controls.F21_split_1_3_3bar true both legs",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "phase0.controls.generic_so16_fails_margin_positive true both legs",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 3,
   "check": "C1",
   "name": "locking_inventory list length equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 0,
   "check": "C1",
   "name": "locking_inventory[rank=0].rank typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 0,
   "check": "C1",
   "name": "locking_inventory[rank=0].rank equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "G2",
   "check": "C1",
   "name": "locking_inventory[rank=0].H0 typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "G2",
   "check": "C1",
   "name": "locking_inventory[rank=0].H0 equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 14,
   "check": "C1",
   "name": "locking_inventory[rank=0].H0_dim typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 14,
   "check": "C1",
   "name": "locking_inventory[rank=0].H0_dim equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 1,
   "check": "C1",
   "name": "locking_inventory[rank=0].pi0_generic typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 1,
   "check": "C1",
   "name": "locking_inventory[rank=0].pi0_generic equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "check": "C1",
   "name": "locking_inventory[rank=0].sl2_generator_jordan_type typed",
   "note": "type list",
   "pass": true
  },
  {
   ...
   "check": "C1",
   "name": "locking_inventory[rank=0].sl2_generator_jordan_type equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 1,
   "check": "C1",
   "name": "locking_inventory[rank=0].sl2_generator_index typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 1,
   "check": "C1",
   "name": "locking_inventory[rank=0].sl2_generator_index equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "locking_inventory[rank=0].pi3_injective typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "locking_inventory[rank=0].pi3_injective equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 0,
   "check": "C1",
   "name": "locking_inventory[rank=0].pi4_quotient typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 0,
   "check": "C1",
   "name": "locking_inventory[rank=0].pi4_quotient equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "G2",
   "check": "C1",
   "name": "locking_inventory[rank=0].H0 in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 1,
   "check": "C1",
   "name": "locking_inventory[rank=1].rank typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 1,
   "check": "C1",
   "name": "locking_inventory[rank=1].rank equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "SU3",
   "check": "C1",
   "name": "locking_inventory[rank=1].H0 typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "SU3",
   "check": "C1",
   "name": "locking_inventory[rank=1].H0 equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 8,
   "check": "C1",
   "name": "locking_inventory[rank=1].H0_dim typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 8,
   "check": "C1",
   "name": "locking_inventory[rank=1].H0_dim equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 1,
   "check": "C1",
   "name": "locking_inventory[rank=1].pi0_generic typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 1,
   "check": "C1",
   "name": "locking_inventory[rank=1].pi0_generic equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "check": "C1",
   "name": "locking_inventory[rank=1].sl2_generator_jordan_type typed",
   "note": "type list",
   "pass": true
  },
  {
   ...
   "check": "C1",
   "name": "locking_inventory[rank=1].sl2_generator_jordan_type equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 1,
   "check": "C1",
   "name": "locking_inventory[rank=1].sl2_generator_index typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 1,
   "check": "C1",
   "name": "locking_inventory[rank=1].sl2_generator_index equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "locking_inventory[rank=1].pi3_injective typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "locking_inventory[rank=1].pi3_injective equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 0,
   "check": "C1",
   "name": "locking_inventory[rank=1].pi4_quotient typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 0,
   "check": "C1",
   "name": "locking_inventory[rank=1].pi4_quotient equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "SU3",
   "check": "C1",
   "name": "locking_inventory[rank=1].H0 in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 2,
   "check": "C1",
   "name": "locking_inventory[rank=2].rank typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 2,
   "check": "C1",
   "name": "locking_inventory[rank=2].rank equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "SU2_long",
   "check": "C1",
   "name": "locking_inventory[rank=2].H0 typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "SU2_long",
   "check": "C1",
   "name": "locking_inventory[rank=2].H0 equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 3,
   "check": "C1",
   "name": "locking_inventory[rank=2].H0_dim typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 3,
   "check": "C1",
   "name": "locking_inventory[rank=2].H0_dim equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 1,
   "check": "C1",
   "name": "locking_inventory[rank=2].pi0_generic typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 1,
   "check": "C1",
   "name": "locking_inventory[rank=2].pi0_generic equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "check": "C1",
   "name": "locking_inventory[rank=2].sl2_generator_jordan_type typed",
   "note": "type list",
   "pass": true
  },
  {
   ...
   "check": "C1",
   "name": "locking_inventory[rank=2].sl2_generator_jordan_type equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 1,
   "check": "C1",
   "name": "locking_inventory[rank=2].sl2_generator_index typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 1,
   "check": "C1",
   "name": "locking_inventory[rank=2].sl2_generator_index equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "locking_inventory[rank=2].pi3_injective typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C1",
   "name": "locking_inventory[rank=2].pi3_injective equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 0,
   "check": "C1",
   "name": "locking_inventory[rank=2].pi4_quotient typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 0,
   "check": "C1",
   "name": "locking_inventory[rank=2].pi4_quotient equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "SU2_long",
   "check": "C1",
   "name": "locking_inventory[rank=2].H0 in domain",
   "note": "",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": 1,
   "check": "C2",
   "name": "phase1.T1.chi32_norm typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 1,
   "check": "C2",
   "name": "phase1.T1.chi32_norm equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 4,
   "check": "C2",
   "name": "phase1.T1.chi32_at_1 typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 4,
   "check": "C2",
   "name": "phase1.T1.chi32_at_1 equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": -4,
   "check": "C2",
   "name": "phase1.T1.chi32_at_minus1 typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": -4,
   "check": "C2",
   "name": "phase1.T1.chi32_at_minus1 equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": -1,
   "check": "C2",
   "name": "phase1.T1.fs_indicator typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": -1,
   "check": "C2",
   "name": "phase1.T1.fs_indicator equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C2",
   "name": "phase1.T1.seven_real typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C2",
   "name": "phase1.T1.seven_real equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 0,
   "check": "C2",
   "name": "phase1.T1.quartet_multiplicity_upper typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 0,
   "check": "C2",
   "name": "phase1.T1.quartet_multiplicity_upper equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C2",
   "name": "phase1.T1.phase_char_on_2O_trivial typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C2",
   "name": "phase1.T1.phase_char_on_2O_trivial equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "check": "C2",
   "name": "phase1.T1.branching_long_root typed",
   "note": "type list",
   "pass": true
  },
  {
   ...
   "check": "C2",
   "name": "phase1.T1.branching_long_root equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "check": "C2",
   "name": "phase1.T1.branching_short_root typed",
   "note": "type list",
   "pass": true
  },
  {
   ...
   "check": "C2",
   "name": "phase1.T1.branching_short_root equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "check": "C2",
   "name": "phase1.T1.branching_su3_sl2 typed",
   "note": "type list",
   "pass": true
  },
  {
   ...
   "check": "C2",
   "name": "phase1.T1.branching_su3_sl2 equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "check": "C2",
   "name": "phase1.T1.branching_principal typed",
   "note": "type list",
   "pass": true
  },
  {
   ...
   "check": "C2",
   "name": "phase1.T1.branching_principal equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 1,
   "check": "C2",
   "name": "phase1.T1.control_sym3_quartet_mult typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 1,
   "check": "C2",
   "name": "phase1.T1.control_sym3_quartet_mult equal",
   "note": "",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": 21,
   "check": "C2",
   "name": "phase1.T2.dim_bivectors_7 typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 21,
   "check": "C2",
   "name": "phase1.T2.dim_bivectors_7 equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 15,
   "check": "C2",
   "name": "phase1.T2.dim_bivectors_6 typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 15,
   "check": "C2",
   "name": "phase1.T2.dim_bivectors_6 equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C2",
   "name": "phase1.T2.g2_in_spin7 typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C2",
   "name": "phase1.T2.g2_in_spin7 equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 8,
   "check": "C2",
   "name": "phase1.T2.dim_g2_cap_su4 typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 8,
   "check": "C2",
   "name": "phase1.T2.dim_g2_cap_su4 equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 48,
   "check": "C2",
   "name": "phase1.T2.spinor_2O_order typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 48,
   "check": "C2",
   "name": "phase1.T2.spinor_2O_order equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 1,
   "check": "C2",
   "name": "phase1.T2.spinor_2O_automorphism_count typed",
   "note": "type int",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": 2,
   "check": "C2",
   "name": "phase1.T2.spinor_2O_quartet_mult typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 2,
   "check": "C2",
   "name": "phase1.T2.spinor_2O_quartet_mult equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 336,
   "check": "C2",
   "name": "phase1.T2.sl27_order typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 336,
   "check": "C2",
   "name": "phase1.T2.sl27_order equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 2,
   "check": "C2",
   "name": "phase1.T2.sl27_sq1_count typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 2,
   "check": "C2",
   "name": "phase1.T2.sl27_sq1_count equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 22,
   "check": "C2",
   "name": "phase1.T2.fs_sum_ordinary typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 22,
   "check": "C2",
   "name": "phase1.T2.fs_sum_ordinary equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "check": "C2",
   "name": "phase1.T2.nu4_allowed typed",
   "note": "type list",
   "pass": true
  },
  {
   ...
   "check": "C2",
   "name": "phase1.T2.nu4_allowed equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": -1,
   "check": "C2",
   "name": "phase1.T2.involution_trace typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": -1,
   "check": "C2",
   "name": "phase1.T2.involution_trace equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C2",
   "name": "phase1.T2.sigma_H_is_automorphism typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C2",
   "name": "phase1.T2.sigma_H_is_automorphism equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": false,
   "check": "C2",
   "name": "phase1.T2.single_unit_negation_is_automorphism typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": false,
   "check": "C2",
   "name": "phase1.T2.single_unit_negation_is_automorphism equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C2",
   "name": "phase1.T2.control_1344_all_automorphisms typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C2",
   "name": "phase1.T2.control_1344_all_automorphisms equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 1344,
   "check": "C2",
   "name": "phase1.T2.group1344_order typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 1344,
   "check": "C2",
   "name": "phase1.T2.group1344_order equal",
   "note": "",
   "pass": true
  },
  {
   "cc": null,
   "chat": 0.7071067811865495,
   "check": "C2",
   "name": "phase1.T2.spinor_2O_min_automorphism_defect (chat) gt 1e-06",
   "note": "",
   "pass": true
  },
  {
   "cc": 0.7071067811865474,
   "chat": null,
   "check": "C2",
   "name": "phase1.T2.spinor_2O_min_automorphism_defect (cc) gt 1e-06",
   "note": "",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": true,
   "check": "C2",
   "name": "phase1.T3.no_internal_double_cover typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C2",
   "name": "phase1.T3.no_internal_double_cover equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C2",
   "name": "phase1.T3.envelope_in_O_kill typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C2",
   "name": "phase1.T3.envelope_in_O_kill equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "Z2",
   "check": "C2",
   "name": "phase1.T3.controls_pi4_S2 typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "Z2",
   "check": "C2",
   "name": "phase1.T3.controls_pi4_S2 equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "Z2",
   "check": "C2",
   "name": "phase1.T3.controls_pi4_S3 typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "Z2",
   "check": "C2",
   "name": "phase1.T3.controls_pi4_S3 equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 24,
   "check": "C2",
   "name": "phase1.T3.controls_pi1_SO3_mod_T typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 24,
   "check": "C2",
   "name": "phase1.T3.controls_pi1_SO3_mod_T equal",
   "note": "",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": 24,
   "check": "C2",
   "name": "phase1.T4.lifts_total typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 24,
   "check": "C2",
   "name": "phase1.T4.lifts_total equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 12,
   "check": "C2",
   "name": "phase1.T4.order2_count typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 12,
   "check": "C2",
   "name": "phase1.T4.order2_count equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "check": "C2",
   "name": "phase1.T4.order2_traces_set typed",
   "note": "type list",
   "pass": true
  },
  {
   ...
   "check": "C2",
   "name": "phase1.T4.order2_traces_set equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 12,
   "check": "C2",
   "name": "phase1.T4.order4_count typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 12,
   "check": "C2",
   "name": "phase1.T4.order4_count equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "check": "C2",
   "name": "phase1.T4.order4_traces_set typed",
   "note": "type list",
   "pass": true
  },
  {
   ...
   "check": "C2",
   "name": "phase1.T4.order4_traces_set equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 3,
   "check": "C2",
   "name": "phase1.T4.perm_char_involution typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 3,
   "check": "C2",
   "name": "phase1.T4.perm_char_involution equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 2,
   "check": "C2",
   "name": "phase1.T4.rho6_char_2A typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 2,
   "check": "C2",
   "name": "phase1.T4.rho6_char_2A equal",
   "note": "",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": true,
   "check": "C2",
   "name": "phase1.T4.control_F21_unsigned_1_3_3bar typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C2",
   "name": "phase1.T4.control_F21_unsigned_1_3_3bar equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C2",
   "name": "phase1.T4.nu2_unsigned_automorphism typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C2",
   "name": "phase1.T4.nu2_unsigned_automorphism equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 1344,
   "check": "C2",
   "name": "phase1.group1344.order typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 1344,
   "check": "C2",
   "name": "phase1.group1344.order equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": false,
   "check": "C2",
   "name": "phase1.group1344.split typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": false,
   "check": "C2",
   "name": "phase1.group1344.split equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 0,
   "check": "C2",
   "name": "phase1.group1344.complements_found typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 0,
   "check": "C2",
   "name": "phase1.group1344.complements_found equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 64,
   "check": "C2",
   "name": "phase1.group1344.lift_pairs_tested typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 64,
   "check": "C2",
   "name": "phase1.group1344.lift_pairs_tested equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C3",
   "name": "phase1b.P_C.complex_unit_central typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C3",
   "name": "phase1b.P_C.complex_unit_central equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C3",
   "name": "phase1b.P_C.e8_anticommutes typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C3",
   "name": "phase1b.P_C.e8_anticommutes equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": false,
   "check": "C3",
   "name": "phase1b.P_C.e8_central typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": false,
   "check": "C3",
   "name": "phase1b.P_C.e8_central equal",
   "note": "",
   "pass": true
  },
  {
   "cc": "CLOSED-BY-INSTANTIATION",
   "chat": "CLOSED-BY-INSTANTIATION",
   "check": "C3",
   "name": "phase1b.P_C.disposition typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "CLOSED-BY-INSTANTIATION",
   "check": "C3",
   "name": "phase1b.P_C.disposition equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "fail",
   "check": "C3",
   "name": "phase1b.H_screen.H1.i typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "fail",
   "check": "C3",
   "name": "phase1b.H_screen.H1.i equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H1.ii typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H1.ii equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "fail",
   "check": "C3",
   "name": "phase1b.H_screen.H1.iii typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "fail",
   "check": "C3",
   "name": "phase1b.H_screen.H1.iii equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "n/a",
   "check": "C3",
   "name": "phase1b.H_screen.H1.iv typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "n/a",
   "check": "C3",
   "name": "phase1b.H_screen.H1.iv equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "EXCLUDED(i,iii)",
   "check": "C3",
   "name": "phase1b.H_screen.H1.code typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "EXCLUDED(i,iii)",
   "check": "C3",
   "name": "phase1b.H_screen.H1.code equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "control",
   "check": "C3",
   "name": "phase1b.H_screen.H1.role typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "control",
   "check": "C3",
   "name": "phase1b.H_screen.H1.role equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "fail",
   "check": "C3",
   "name": "phase1b.H_screen.H1.i (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H1.i (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H1.ii (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H1.ii (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "fail",
   "check": "C3",
   "name": "phase1b.H_screen.H1.iii (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H1.iii (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "n/a",
   "check": "C3",
   "name": "phase1b.H_screen.H1.iv (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H1.iv (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H2.i typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H2.i equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H2.ii typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H2.ii equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H2.iii typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H2.iii equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "dynamical",
   "check": "C3",
   "name": "phase1b.H_screen.H2.iv typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "dynamical",
   "check": "C3",
   "name": "phase1b.H_screen.H2.iv equal",
   "note": "",
   "pass": true
  },
  {
   "cc": "ADMISSIBLE-IMPORT",
   "chat": "ADMISSIBLE-IMPORT",
   "check": "C3",
   "name": "phase1b.H_screen.H2.code typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "ADMISSIBLE-IMPORT",
   "check": "C3",
   "name": "phase1b.H_screen.H2.code equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "candidate",
   "check": "C3",
   "name": "phase1b.H_screen.H2.role typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "candidate",
   "check": "C3",
   "name": "phase1b.H_screen.H2.role equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H2.i (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H2.i (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H2.ii (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H2.ii (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H2.iii (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H2.iii (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "dynamical",
   "check": "C3",
   "name": "phase1b.H_screen.H2.iv (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H2.iv (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H3.i typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H3.i equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H3.ii typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H3.ii equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "conditional",
   "check": "C3",
   "name": "phase1b.H_screen.H3.iii typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "conditional",
   "check": "C3",
   "name": "phase1b.H_screen.H3.iii equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "kinematic",
   "check": "C3",
   "name": "phase1b.H_screen.H3.iv typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "kinematic",
   "check": "C3",
   "name": "phase1b.H_screen.H3.iv equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "ADMISSIBLE-IMPORT",
   "check": "C3",
   "name": "phase1b.H_screen.H3.code typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "ADMISSIBLE-IMPORT",
   "check": "C3",
   "name": "phase1b.H_screen.H3.code equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "candidate",
   "check": "C3",
   "name": "phase1b.H_screen.H3.role typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "candidate",
   "check": "C3",
   "name": "phase1b.H_screen.H3.role equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H3.i (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H3.i (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H3.ii (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H3.ii (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "conditional",
   "check": "C3",
   "name": "phase1b.H_screen.H3.iii (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H3.iii (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "kinematic",
   "check": "C3",
   "name": "phase1b.H_screen.H3.iv (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H3.iv (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "fail",
   "check": "C3",
   "name": "phase1b.H_screen.H4.i typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "fail",
   "check": "C3",
   "name": "phase1b.H_screen.H4.i equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H4.ii typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H4.ii equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "n/a",
   "check": "C3",
   "name": "phase1b.H_screen.H4.iii typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "n/a",
   "check": "C3",
   "name": "phase1b.H_screen.H4.iii equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "n/a",
   "check": "C3",
   "name": "phase1b.H_screen.H4.iv typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "n/a",
   "check": "C3",
   "name": "phase1b.H_screen.H4.iv equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "EXCLUDED(i)",
   "check": "C3",
   "name": "phase1b.H_screen.H4.code typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "EXCLUDED(i)",
   "check": "C3",
   "name": "phase1b.H_screen.H4.code equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "candidate",
   "check": "C3",
   "name": "phase1b.H_screen.H4.role typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "candidate",
   "check": "C3",
   "name": "phase1b.H_screen.H4.role equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "fail",
   "check": "C3",
   "name": "phase1b.H_screen.H4.i (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H4.i (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "pass",
   "check": "C3",
   "name": "phase1b.H_screen.H4.ii (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H4.ii (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "n/a",
   "check": "C3",
   "name": "phase1b.H_screen.H4.iii (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H4.iii (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "n/a",
   "check": "C3",
   "name": "phase1b.H_screen.H4.iv (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H4.iv (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "fail",
   "check": "C3",
   "name": "phase1b.H_screen.H5.i typed",
   "note": "type str",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": "fail",
   "check": "C3",
   "name": "phase1b.H_screen.H5.ii typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "fail",
   "check": "C3",
   "name": "phase1b.H_screen.H5.ii equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "n/a",
   "check": "C3",
   "name": "phase1b.H_screen.H5.iii typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "n/a",
   "check": "C3",
   "name": "phase1b.H_screen.H5.iii equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "n/a",
   "check": "C3",
   "name": "phase1b.H_screen.H5.iv typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "n/a",
   "check": "C3",
   "name": "phase1b.H_screen.H5.iv equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "EXCLUDED(i,ii)",
   "check": "C3",
   "name": "phase1b.H_screen.H5.code typed",
   "note": "type str",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": "candidate",
   "check": "C3",
   "name": "phase1b.H_screen.H5.role typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "candidate",
   "check": "C3",
   "name": "phase1b.H_screen.H5.role equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "fail",
   "check": "C3",
   "name": "phase1b.H_screen.H5.i (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H5.i (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "fail",
   "check": "C3",
   "name": "phase1b.H_screen.H5.ii (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H5.ii (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "n/a",
   "check": "C3",
   "name": "phase1b.H_screen.H5.iii (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H5.iii (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "n/a",
   "check": "C3",
   "name": "phase1b.H_screen.H5.iv (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C3",
   "name": "phase1b.H_screen.H5.iv (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C3",
   "name": "phase1b.I5_registered typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C3",
   "name": "phase1b.I5_registered equal",
   "note": "",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "check": "C3",
   "name": "phase1b.admissible equal",
   "note": "",
   "pass": true
  },
  {
   "cc": "fano_line_texture_L124_homogeneous_GP_2D",
   "chat": "fano_line_texture_L124_homogeneous_GP_2D",
   "check": "C4",
   "name": "phase2.object typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "fano_line_texture_L124_homogeneous_GP_2D",
   "check": "C4",
   "name": "phase2.object equal",
   "note": "",
   "pass": true
  },
  {
   "cc": "nonline_texture_L123",
   "chat": "nonline_texture_L123",
   "check": "C4",
   "name": "phase2.control_object typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "nonline_texture_L123",
   "check": "C4",
   "name": "phase2.control_object equal",
   "note": "",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": true,
   "check": "C4",
   "name": "phase2.O_nonzero_on_line typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C4",
   "name": "phase2.O_nonzero_on_line equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C4",
   "name": "phase2.O_zero_on_nonline typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C4",
   "name": "phase2.O_zero_on_nonline equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "SO4_Stab_HL",
   "check": "C4",
   "name": "phase2.stab_internal_image typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "SO4_Stab_HL",
   "check": "C4",
   "name": "phase2.stab_internal_image equal",
   "note": "",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": true,
   "check": "C4",
   "name": "phase2.stab_subdirect typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C4",
   "name": "phase2.stab_subdirect equal",
   "note": "",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": 4,
   "check": "C4",
   "name": "phase2.sigma_H_eigen_plus1 typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 4,
   "check": "C4",
   "name": "phase2.sigma_H_eigen_plus1 equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 4,
   "check": "C4",
   "name": "phase2.sigma_H_eigen_minus1 typed",
   "note": "type int",
   "pass": true
  },
  {
   ...
   "chat": 4,
   "check": "C4",
   "name": "phase2.sigma_H_eigen_minus1 equal",
   "note": "",
   "pass": true
  },
  {
   "cc": "INTERNAL-HOLONOMY-GAUGE",
   "chat": "INTERNAL-HOLONOMY-GAUGE",
   "check": "C4",
   "name": "phase2.label typed",
   "note": "type str",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": true,
   "check": "C4",
   "name": "phase2.chiral_pair_character_ordinary typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C4",
   "name": "phase2.chiral_pair_character_ordinary equal",
   "note": "",
   "pass": true
  },
  {
   "cc": "2D witness; contractibility of the 2pi loop in the orbit only",
   "chat": "2D witness; contractibility of the 2pi loop in the orbit only",
   "check": "C4",
   "name": "phase2.dimension_note typed",
   "note": "type str",
   "pass": true
  },
  {
   ...
   "chat": "2D witness; contractibility of the 2pi loop in the orbit only",
   "check": "C4",
   "name": "phase2.dimension_note equal",
   "note": "",
   "pass": true
  },
  {
   "cc": null,
   "chat": 12.566370614359172,
   "check": "C4",
   "name": "phase2.O_line_abs (chat) gt 1e-06",
   "note": "",
   "pass": true
  },
  {
   "cc": 12.566369857446146,
   "chat": null,
   "check": "C4",
   "name": "phase2.O_line_abs (cc) gt 1e-06",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": 0.0,
   "check": "C4",
   "name": "phase2.O_nonline_abs (chat) le 1e-09",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C4",
   "name": "phase2.O_nonline_abs (cc) le 1e-09",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "INTERNAL-HOLONOMY-GAUGE",
   "check": "C4",
   "name": "phase2.label (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C4",
   "name": "phase2.label (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   "cc": "ASSIGNMENT-I-FORCED",
   "chat": "ASSIGNMENT-I-FORCED",
   "check": "C5",
   "name": "phase3.verdict typed",
   "note": "type str",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "check": "C5",
   "name": "phase3.tests_holding typed",
   "note": "type list",
   "pass": true
  },
  {
   ...
   "check": "C5",
   "name": "phase3.tests_holding equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "check": "C5",
   "name": "phase3.admissible_H typed",
   "note": "type list",
   "pass": true
  },
  {
   ...
   "check": "C5",
   "name": "phase3.admissible_H equal",
   "note": "",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": true,
   "check": "C5",
   "name": "phase3.controls_all_pass typed",
   "note": "type bool",
   "pass": true
  },
  {
   ...
   "chat": true,
   "check": "C5",
   "name": "phase3.controls_all_pass equal",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": "ASSIGNMENT-I-FORCED",
   "check": "C5",
   "name": "phase3.verdict (chat) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C5",
   "name": "phase3.verdict (cc) in domain",
   "note": "",
   "pass": true
  },
  {
   ...
   "note": "reported ASSIGNMENT-I-FORCED",
   "pass": true
  },
  {
   "cc": null,
   "chat": true,
   "check": "C5",
   "name": "controls_all_pass recomputed == reported (chat)",
   "note": "",
   "pass": true
  },
  {
   ...
   "check": "C5",
   "name": "tests_holding consistent with T*.holds (chat)",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C5",
   "name": "admissible_H == phase1b.admissible (chat)",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C5",
   "name": "I5 == phase1b.I5_registered (chat)",
   "note": "",
   "pass": true
  },
  {
  ...
  },
  {
   ...
   "chat": null,
   "check": "C5",
   "name": "controls_all_pass recomputed == reported (cc)",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C5",
   "name": "tests_holding consistent with T*.holds (cc)",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C5",
   "name": "admissible_H == phase1b.admissible (cc)",
   "note": "",
   "pass": true
  },
  {
   ...
   "chat": null,
   "check": "C5",
   "name": "I5 == phase1b.I5_registered (cc)",
   "note": "",
   "pass": true
  }
 ],
 "schema_md5": "53111e0360dac138b02d5914efe85d5c",
 "summary": {
  "checks": 436,
  "miss": 6,
  "pass": 430
...
=====END-EMBED name=g_2a_a1_twoleg_comparison.json=====

=====BEGIN-EMBED name=g_2a_a1_chatleg_compare.json md5=ba0876074396e697614a4daa78da7682 bytes=66541 encoding=raw=====
{
 "cc_ckpt_md5": "8f657a23a68ef082f99a7579af78348c",
 "chat_ckpt_md5": "8f657a23a68ef082f99a7579af78348c",
 "comparator": "g_2a_a1_compare_v1_0",
 "misses": [
  {
  ...
  {
   "cc": "6360709d6a7eb5fc3df7fc8fd26dc36a",
   "chat": "6360709d6a7eb5fc3df7fc8fd26dc36a",
   "check": "C0",
   "name": "independence witness: instrument_md5 differ",
   "note": "",
...
=====BEGIN-EMBED name=g_2a_a1_ccleg_compare.json md5=73a19a11288475ed3eb8935e0a3f9c66 bytes=66209 encoding=raw=====
{
 "cc_ckpt_md5": "bbf94221122136f00c5ecad0b90e5313",
 "chat_ckpt_md5": "bbf94221122136f00c5ecad0b90e5313",
 "comparator": "g_2a_a1_compare_v1_0",
 "misses": [
  {
   "cc": "cc",
  ...
  {
   "cc": "006cb5213208e41cc57cfe045b7d3dd4",
   "chat": "006cb5213208e41cc57cfe045b7d3dd4",
   "check": "C0",
   "name": "independence witness: instrument_md5 differ",
   "note": "",
   "pass": false
...
=====END-EMBED name=g_2a_a1_ccleg_compare.json=====
