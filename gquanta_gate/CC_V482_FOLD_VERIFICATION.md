...
The G-QUANTA T1 list (13 pattern lines, md5 prefix `04438b74`, per the G-2a-L1 estate) was never
supplied to either leg. All four T1 lists already in the tree were hashed and none is it:
...
So `D-Q-1 / D-T1` was unavoidable on both legs rather than an oversight, and the standing remedy is
unchanged: the list travels in-band in the next dispatch.
