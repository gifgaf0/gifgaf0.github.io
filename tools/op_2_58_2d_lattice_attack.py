...
# ---------------------------------------------------------------------------
# Fano-projected basis (b) — POST-FREEZE STUB
# ---------------------------------------------------------------------------


def build_fano_projected_lattice(*args, **kwargs):  # noqa: ANN002, ANN003
    """Basis (b) of §3.6 — the Fano-projected lattice.

    POST-FREEZE / OUT OF SCOPE for this brief (brief §3.1, §3.4). It
    depends on the actual §2.58.B Fano-line subspace data, which is a
    separate task. Intentionally unimplemented.
    """
    raise NotImplementedError(
        "Fano-projected basis (b) is post-freeze; depends on §2.58.B "
        "Fano-line subspace data (brief §3.1, §3.4). Out of scope for item 3."
    )
